// cuon-matrix-cse160.js (c) 2012 kanda and matsuda
/**
...
class Vector3 {
    ...
    div(scalar) {
        ...
        d = this.elements;
        if(scalar == 0) {
          console.log("You know better than to divide by 0.")
          return;
        }
    ...
    static cross(other1, other2) {
        ...
        e1 = v1[1] * v2[2] - v1[2] * v2[1];
        e2 = v1[2] * v2[0] - v1[0] * v2[2];
        e3 = v1[0] * v2[1] - v1[1] * v2[0];

        v3.set(new Vector3([e1, e2, e3]));
        return v3;
    }
